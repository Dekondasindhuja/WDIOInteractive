# WDIOInteractive is a framework written in Javascript and its using nodeJS. Also its following page object model and can execute the scenarios using WebdriverIO.
